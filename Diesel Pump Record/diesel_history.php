...
<head>
    ...
    <title>📜 Diesel Stock History</title>
...
<div class="container mt-5">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2>📜 Diesel Stock Addition History</h2>
        <h4 class="text-success">Total Stock Added: **<?php echo number_format($total_added, 2); ?> L**</h4>
    </div>

    <div class="row mb-4">
        <div class="col-md-6">
            <form class="d-flex" action="diesel_history.php" method="GET">
    ...
    <table class="table table-striped table-hover">
        ...
        <tbody>
            ...
            if ($history_result && $history_result->num_rows > 0) {
                ...
                echo "<tr><td colspan='4' class='text-center'>No diesel stock additions recorded yet or for the search date.</td></tr>";
            }
            ?>
        </tbody>
    </table>
